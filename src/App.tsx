  ...
  useEffect(() => {
    ...
    try {
      ...
      if (url.searchParams.get('tiktok_auth') === 'success') {
        const rawUser = url.searchParams.get('username') || '@lightsouttattoo';
        const rawDisplay = url.searchParams.get('display_name') || 'Tex • Lead Artist';
        const rawAvatar = url.searchParams.get('avatar') || 'https://images.unsplash.com/photo-1578632767115-351597cf2477?auto=format&fit=crop&w=800&q=80';

...
export const tiktokService = {
  ...
  async getAuthUrl(redirectUri?: string, scopes?: string, returnUrl?: string): Promise<{ authUrl?: string; state?: string; redirectUri?: string; scopes?: string; returnUrl?: string; error?: string }> {
    try {
